...
output "gitops-console-link-job_name" {
  description = "The name of the module"
  value = module.gitops-console-link-job.name
}
output "gitops-console-link-job_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-console-link-job.branch
}
output "gitops-console-link-job_namespace" {
  description = "The namespace where the module will be deployed"
  value = module.gitops-console-link-job.namespace
}
output "gitops-console-link-job_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-console-link-job.server_name
}
output "gitops-console-link-job_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-console-link-job.layer
}
output "gitops-console-link-job_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-console-link-job.type
}
output "toolkit_namespace_name" {
  description = "Namespace name"
  value = module.toolkit_namespace.name
}
