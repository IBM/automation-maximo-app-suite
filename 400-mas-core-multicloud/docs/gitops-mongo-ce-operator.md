# MongoDB Community Edition Operator gitops module

Module to populate a gitops repository with the resources required to provision the MongoDB Community Edition operator.
