output "aws-portworx_rwx_storage_class" {
  description = "the value of aws-portworx_rwx_storage_class"
  value = module.aws-portworx.rwx_storage_class
}
output "aws-portworx_rwo_storage_class" {
  description = "the value of aws-portworx_rwo_storage_class"
  value = module.aws-portworx.rwo_storage_class
}
output "aws-portworx_file_storage_class" {
  description = "the value of aws-portworx_file_storage_class"
  value = module.aws-portworx.file_storage_class
}
output "aws-portworx_block_storage_class" {
  description = "the value of aws-portworx_block_storage_class"
  value = module.aws-portworx.block_storage_class
}
output "aws-portworx_storage_classes_provided" {
  description = "the value of aws-portworx_storage_classes_provided"
  value = module.aws-portworx.storage_classes_provided
}
output "cluster_id" {
